...
def calc_fft(y, samples, time):
    print('Entering calc_fft')
    fft_vector = fft(y)
    print('fft calc completed')
...
plot_fft(samplefreqarr, amp_vector,'Amplitude of Composite Signal','Frequency[Hz]','PSD','plot',1,peaks)
