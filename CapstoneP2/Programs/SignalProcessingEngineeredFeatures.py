...
#print("Accuracy on training set is : {}".format(clf.score(X_train_pre, y_train)))
#print("Accuracy on test set is : {}".format(clf.score(X_test_pre, y_test)))
...
knn_cls.fit(X_train_pre,y_train)
print("Accuracy on training set is : {}".format(knn_cls.score(X_train_pre, y_train)))
print("Accuracy on test set is : {}".format(knn_cls.score(X_test_pre, y_test)))
y_pred = knn_cls.predict(X_test_pre)
print(classification_report(y_test, y_pred))
...
##                  verbose=2
##                 )
#svm_cls.fit(X_train_pre,y_train)
#print("Accuracy on training set is : {}".format(svm_cls.score(X_train_pre, y_train)))
#print("Accuracy on test set is : {}".format(svm_cls.score(X_test_pre, y_test)))
#y_pred = svm_cls.predict(X_test_pre)
#print(classification_report(y_test, y_pred))
...
#train_features = train_signals.reshape(train_signal_length,segment_size,1)
#test_features = test_signals.reshape(test_signal_length,segment_size,1)
#
## fit model
