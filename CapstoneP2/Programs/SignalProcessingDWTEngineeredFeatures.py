...
#
def extract_dwt_features(signals, waveletname,level=3):
    all_features = []
...
#waveletname = 'coif1' #tried .79
#waveletname = 'haar' #tried .79
#waveletname = 'db2' #tried ..79
#waveletname = 'sym3' #tried .78
#waveletname = 'sym6' #tried .79
waveletname = 'sym2' #tried .80
#waveletname = 'bior3.5' #tried .77
#waveletname = 'rbio3.1' #tried .76
