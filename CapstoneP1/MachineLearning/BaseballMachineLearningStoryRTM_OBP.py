...
df = normalize_values(df,['decade', 'lag1_OBP', 'lag1_cOBP', 'lag1_OB', 'lag1_PA', 'lag1_cOB', 'lag1_cPA', 'lag1_rtm_OB','lag1_rtm_PA','lag1_rtm_OBP','lag1_rtm_cOB','lag1_rtm_cPA','lag1_rtm_cOBP',  'age', 'height', 'weight'],
                         ['ndecade','lag1_nOBP','lag1_ncOBP','lag1_nOB','lag1_nPA','lag1_ncOB', 'lag1_ncPA','lag1_rtm_nOB','lag1_rtm_nPA','lag1_rtm_nOBP','lag1_rtm_ncOB','lag1_rtm_ncPA','lag1_rtm_ncOBP', 'nage','nheight','nweight'],'zeromean')
...
stats_list = ['yearID','playername','OBP','predOBP','error','AB','H','AVG','HR','3B','2B','1B','POS','age','height','lag1_rtm_OBP']

# make run with out regression to the mean lag statistics
feature_list =  ['nage','nheight','ndecade','lag1_nOBP','lag1_ncOBP','lag1_nOB','lag1_nPA','lag1_ncOB', 'lag1_ncPA']
...
feature_list_rttm =  ['nage','nheight','ndecade','lag1_rtm_nOBP','lag1_rtm_ncOBP','lag1_rtm_nOB','lag1_rtm_nPA','lag1_rtm_ncOB','lag1_rtm_ncPA']
