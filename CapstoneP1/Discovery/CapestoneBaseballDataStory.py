...
print(len(dfbatting_player_stats))

#
# only take players who started their careers from 1954 onwards
#
...
plate_appear = df.AB.sum()
print('\n\n')
print('Total Population of Players from 1954 to 2018: ' + str(len(dfplayers_unique)))
print('\n')
print('Total # of yearly player statistics 1954 to 2018: ' + str( len(dfbatting_player_stats) ) )
print('\n')
print('Total # of Plate Appearances 1954 to 2018: ' + str( plate_appear ) )
print('\n')
