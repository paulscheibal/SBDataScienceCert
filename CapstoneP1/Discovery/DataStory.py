...
ax = dfplayers_scatter.plot(kind='scatter', x='OPS',y='age',figsize=(10,7),color='#86bf91')
...
ax = dfplayers_scatter.plot(kind='scatter', x='OPS',y='years_played',figsize=(10,7),color='#86bf91')
...
ax = dfcatchers_scatter.plot(kind='scatter', x='OPS',y='age',figsize=(10,7),color='#86bf91')
